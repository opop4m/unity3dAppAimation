...
namespace XFramework
{
    ...
    public class PanelManager
    {
        ...
        public static string DefaultCanvasName = "Canvas";
        ...
        public PanelManager()
        {
            ...
            canvasObj = GameObject.Find(DefaultCanvasName);
        }
...
#if UNITY_EDITOR
            // string _path = $"Assets/Resources/{ui.Path}.prefab";
        ...
        public void DestroyUI(UIType ui, bool isDestroy)
        {
            if (dictUI.ContainsKey(ui.Path))
            {
                if (isDestroy)
        ...
        public void Push(BasePanel newPanel)
        {
            ...
            if (!dictPanel.ContainsKey(newPanel.UI.Path))
            {
                ...
                newPanel.CurrentTransform = obj.transform as RectTransform;
