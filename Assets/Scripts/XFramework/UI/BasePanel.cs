...
namespace XFramework
{
    ...
    {
        private RectTransform curPanel;
        ...
        /// 当前活动面板
        /// </summary>
        public RectTransform CurrentTransform { get => curPanel; set => curPanel = value; }
        ...
        public GesturePanel gesture { get; private set; }
        ...
        public void Initializa(PanelManager manager)
        {
            ...
            gesture = curPanel.gameObject.GetComponent<GesturePanel>();
        }
        ...
        {
            curPanel.PanelAppearance(true);
            curPanel.SetSiblingIndex(curPanel.parent.childCount - 1);
            if (!ui.Init)
            {
                InitEvent();
                ui.Init = true;
        ...
        {
            curPanel.GetOrAddComponent<CanvasGroup>().blocksRaycasts = true;
        }
        ...
        {
            curPanel.GetOrAddComponent<CanvasGroup>().blocksRaycasts = false;
        }
        ...
        public virtual void OnDestroy(bool isDestroy = true)
        {
